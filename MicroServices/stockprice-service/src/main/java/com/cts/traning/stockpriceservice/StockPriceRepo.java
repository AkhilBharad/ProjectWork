...
import com.cts.traning.stockpriceservice.StockPrice;
...
public interface StockPriceRepo extends JpaRepository<StockPrice, Integer>{
	...
	@Query("SELECT new com.cts.traning.stockpriceservice.StockPriceOnPeriod(companyCode,stockExchange,date,AVG(currentPrice)) " 
	           + "FROM StockPrice " 
